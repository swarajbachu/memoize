...
export const PLAN_MODE_HTML_INSTRUCTIONS = [
  ...
  "",
  "The document MUST begin with `<!DOCTYPE html>` as its very first characters —",
  "do NOT put any text, prose, or HTML comment before it (that breaks rendering).",
  "If you want to note your design choice, put it in a small footer INSIDE",
  "`<body>`, not before the doctype.",
  "",
